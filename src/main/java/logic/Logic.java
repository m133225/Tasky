...
public class Logic {
    ...
    /**
     * Add the alias lists read from the config file to the main.java.parser
     */
    ...
    /**
     * Adds the new aliasString to main.java.parser's list of command keywords
        ...
        if (commandType == null) {
            ...
            switch (commandType) {
                ...
                case DISPLAY :
                    ...
                    Command displayCommand = new CommandFilter(listFilter, new Task());
                    return displayCommand.execute();
                case UNDO :
                ...
                case SEARCH:
                    ...
                    Command searchCommand = new CommandFilter(listFilter, userTask);
